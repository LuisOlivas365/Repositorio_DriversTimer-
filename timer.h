...
/**
 * @brief Configurate the hardware timer and let it ready for use.
 *
 * @param group_num Timer group, 0 for TIMERG0 or 1 for TIMERG1
 * @param timer_num Timer index, 0 for hw_timer[0] & 1 for hw_timer[1]
 * @param reload Counter reload mode.
...
void TimerS(int group, int timer, bool auto_reload, int timer_interval_sec);
static bool IRAM_ATTR timer_group_isr_callback(void *args);

/**
 * @brief Function for waiting the time to pass.
 *
 * @param group_num Timer group, 0 for TIMERG0 or 1 for TIMERG1
 * @param timer_num Timer index, 0 for hw_timer[0] & 1 for hw_timer[1]
 */
