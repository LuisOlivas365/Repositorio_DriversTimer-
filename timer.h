 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
esp_err_t td_isr_callback_add(timer_group_t group_num, timer_idx_t timer_num, timer_isr_t isr_handler, void *arg, int intr_alloc_flags);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
esp_err_t tdGroup_intr_enable(timer_group_t group_num, timer_intr_t intr_mask);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
esp_err_t tdGroup_intr_disable(timer_group_t group_num, timer_intr_t intr_mask);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
esp_err_t tdSpinlock_take(timer_group_t group_num) __attribute__ ((deprecated));
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
esp_err_t tdSpinlock_give(timer_group_t group_num) __attribute__ ((deprecated));
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
esp_err_t TimerS(timer_group_t group_num, timer_idx_t timer_num, uint64_t load_val, timer_count_dir_t counter_dir, timer_autoreload_t reload, timer_isr_t isr_handler, void *arg, int intr_alloc_flags);
...
void chlorineHIGH(timer_group_t group_num, timer_idx_t timer_num, uint64_t load_val,timer_count_dir_t counter_dir);
